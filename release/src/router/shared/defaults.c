...
#elif defined(GTBE98)
	/* no licence screen in first-time setup and no policy pop-ups (QIS_wizard.htm,
	 * state.js); the ASUS cloud services are not built.  The privacy policy
	 * (ASUS_PP, kept by the closed webapi code) is left unsigned. */
	{ "ASUS_EULA", "1", CKN_STR1, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },
#else
	{ "ASUS_EULA", "0", CKN_STR1, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },
#endif
#if defined(GTBE98) && !defined(RTCONFIG_DEMOUI)
	{ "ASUS_NEW_EULA", "1", CKN_STR1, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },
#else
...
//	{ "wl_mimo_preamble", "gfbcm", CKN_STR_DEFAULT, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* Mimo PrEamble: mm/gf/auto/gfbcm */
	...
	{ "wl_sr_level", "0", CKN_STR_DEFAULT, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* GT-BE98: Spatial Reuse (OBSS-PD) aggressiveness 0(off)..10(max) */
	{ "wl_sr_auto", "1", CKN_STR_DEFAULT, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* GT-BE98: 1 = auto-pick SR level from measured OBSS every 15 min (default on) */
	{ "wl_sr_auto_status", "", CKN_STR_DEFAULT, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* auto-mode status string shown in the web UI */
	{ "wl_sr_chanim_before", "", CKN_STR_DEFAULT, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* chanim snapshot before apply: "txop busy glitch" */
	{ "wl_sr_chanim_after", "", CKN_STR_DEFAULT, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* chanim snapshot after apply: "txop busy glitch" */
...
//#ifdef RTCONFIG_SWITCH_CONTROL_8367
	...
	{ "ctrld_enable", "0", CKN_STR1, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* GT-BE98: Control D (ctrld) DNS forwarder, 0=off by default (opt-in overlay) */
	{ "ctrld_uid", "", CKN_STR64, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* GT-BE98: Control D resolver UID from the admin panel */
	{ "ctrld_cache", "1", CKN_STR1, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },	/* GT-BE98: ctrld DNS cache on/off (default on) */
...
/* Merlin-specific settings */
	...
	{ "unrestrict_wl", "0", CKN_STR1, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },        // 1: remove Wi-Fi regulatory restrictions on boot (GT-BE98)
...
/* End of Merlin-specific settings */
	...
	{ "noconsole", "1", CKN_STR1, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },
	/* reaper v1.5.8: this ungated entry duplicated the gated 6G entry near the top
	 * of the table with a conflicting value ("0" here, "1" there), so a factory
	 * reset landed psc6g=0 while an upgrade key-fill landed 1. Align to the
	 * intended default. */
	{ "psc6g", "1", CKN_STR2, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },
